...
ACLOCAL = ${SHELL} /home/azbest/profiling/valgrind-3.7.0/missing --run aclocal-1.11
AMTAR = ${SHELL} /home/azbest/profiling/valgrind-3.7.0/missing --run tar
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/azbest/profiling/valgrind-3.7.0/missing --run autoconf
AUTOHEADER = ${SHELL} /home/azbest/profiling/valgrind-3.7.0/missing --run autoheader
AUTOMAKE = ${SHELL} /home/azbest/profiling/valgrind-3.7.0/missing --run automake-1.11
AWK = gawk
BOOST_CFLAGS = 
BOOST_LIBS = 
CC = gcc
...
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} /home/azbest/profiling/valgrind-3.7.0/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
MPI_CC = mpicc
OBJEXT = o
PACKAGE = valgrind
...
abs_builddir = /home/azbest/profiling/valgrind-3.7.0
abs_srcdir = /home/azbest/profiling/valgrind-3.7.0
abs_top_builddir = /home/azbest/profiling/valgrind-3.7.0
abs_top_srcdir = /home/azbest/profiling/valgrind-3.7.0
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /home/azbest/profiling/valgrind-3.7.0/install-sh
...
pdfdir = ${docdir}
prefix = /home/azbest/profiling/valgrind-3.7.0/inst
...
AM_CCASFLAGS_ARM_LINUX = $(AM_CPPFLAGS_ARM_LINUX) -m32 \
...
installdirs-am:
	for dir in "$(DESTDIR)$(pkgconfigdir)" "$(DESTDIR)$(pkglibdir)" "$(DESTDIR)$(pkgincludedir)"; do \
...
regtest: check
	...
	/usr/bin/perl tests/vg_regtest gdbserver_tests $(TEST_TOOLS) $(TEST_EXP_TOOLS)
nonexp-regtest: check
	/usr/bin/perl tests/vg_regtest $(TEST_TOOLS)
exp-regtest: check
	/usr/bin/perl tests/vg_regtest gdbserver_tests $(TEST_EXP_TOOLS)
